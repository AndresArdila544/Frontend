<template>
  <div>
    <div v-if="!submitted">
    <vs-row class=" container-fluid content-inputs " justify="space-between">
        <vs-col  w="6" class="justify-content-start">
        ...
        <vs-col w="6" class="d-flex flex-column justify-content-start ">
